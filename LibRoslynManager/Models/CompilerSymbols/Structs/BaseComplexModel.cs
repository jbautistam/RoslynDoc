...
namespace Bau.Libraries.LibRoslynManager.Models.CompilerSymbols.Structs
{
	...
	public abstract class BaseComplexModel : Base.LanguageStructModel
	{
		...
		///		Clase base
		/// </summary>
		public Base.TypedModel BaseClass { get; internal set; }

		/// <summary>
		///		Interfaces que implementa
		/// </summary>
		public System.Collections.Generic.List<string> Interfaces { get; internal set; } = new System.Collections.Generic.List<string>();

		/// <summary>
		///		Tipos de los parámetros genéricos
		/// </summary>
		public System.Collections.Generic.List<Simple.TypeParameterModel> TypeParameters { get; internal set; } = new System.Collections.Generic.List<Simple.TypeParameterModel>();
	}
}
