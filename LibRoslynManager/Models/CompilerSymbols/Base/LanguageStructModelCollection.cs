...
namespace Bau.Libraries.LibRoslynManager.Models.CompilerSymbols.Base
{
	/// <summary>
	...
	public class LanguageStructModelCollection : List<LanguageStructModel>
	{
		...
		/// </summary>
		internal Structs.NameSpaceModel CreateSpaceModel(LanguageStructModel objParent)
		...
		///		Crea una clase
		/// </summary>
		internal Structs.ClassModel CreateClass(LanguageStructModel objParent)
		...
		///		Crea una estructura
		/// </summary>
		internal Structs.StructModel CreateStruct(LanguageStructModel objParent)
		...
		///		Crea un interface
		/// </summary>
		internal Structs.InterfaceModel CreateInterface(LanguageStructModel objParent)
		...
		///		Crea un método
		/// </summary>
		internal Methods.MethodModel CreateMethod(LanguageStructModel objParent)
		...
		///		Crea un enumerado
		/// </summary>
		internal Simple.EnumModel CreateEnum(LanguageStructModel objParent)
		...
		/// </summary>
		internal Simple.EnumMemberModel CreateEnumMember(LanguageStructModel objParent)
		...
		///		Crea una propiedad
		/// </summary>
		internal Methods.PropertyModel CreateProperty(LanguageStructModel objParent)
		...
		///		Crea un constructor
		/// </summary>
		internal Methods.ConstructorModel CreateConstructor(LanguageStructModel objParent)
