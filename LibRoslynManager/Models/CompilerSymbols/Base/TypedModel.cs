...
namespace Bau.Libraries.LibRoslynManager.Models.CompilerSymbols.Base
{
	...
	public class TypedModel : LanguageBaseModel
	{
		...
		///		Tipo base
		/// </summary>
		public TypedModel BaseType { get; internal set; }
		...
		/// </summary>
		public System.Collections.Generic.List<TypedModel> Constraints { get; internal set; } = new System.Collections.Generic.List<TypedModel>();
	}
}
